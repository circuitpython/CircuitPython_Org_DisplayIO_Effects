...
setup(
    ...
    description="Add some flair to your widgets with effects!",
    long_description=long_description,
    long_description_content_type="text/x-rst",
    # The project's main homepage.
    url="https://github.com/tekktrik/CircuitPython_Org_DisplayIO_Effects.git",
    # Author details
    author="Alec Delaney",
